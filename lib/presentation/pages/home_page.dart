...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                      ...
                      return state.maybeWhen(
                        ...
                        loaded: (model) {
                          return GridView.builder(
                              physics:
                                  const NeverScrollableScrollPhysics(), // Nonaktifkan pengguliran GridView
                              shrinkWrap: true,
        ...
        //         label: 'Home'),
        //     BottomNavigationBarItem(
        //         icon: Icon(Icons.restaurant), label: 'Search'),
        //     BottomNavigationBarItem(
        //         icon: Icon(Icons.restaurant_menu), label: 'My Restaurant'),
